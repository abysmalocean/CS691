...
int main(int argc, char *argv[])
{
    ...
    printf("The 1NN classifier for %lu instances and %lu instance required %llu ms CPU time, accuracy was %.4f\n", dataset->num_instances(),dataset->num_attributes(), (long long unsigned int) diff, accuracy);
}
